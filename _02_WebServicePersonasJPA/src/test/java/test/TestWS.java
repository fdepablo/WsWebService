...
public class TestWS {
	...
	public void testWS() {
		try {
			URL url = new URL("http://localhost:8080/_02_WebServicePersonasJPA-0.0.1-SNAPSHOT/PersonaWSImplements?wsdl");
			...
			int baja = ws.baja(2);
			System.out.println("Test: Persona dada de baja con id: " + baja);
